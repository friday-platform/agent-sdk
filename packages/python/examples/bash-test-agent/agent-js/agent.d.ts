...
export type * as FridayAgentCapabilities010 from './interfaces/friday-agent-capabilities.js'; // import friday:agent/capabilities@0.1.0
export type * as FridayAgentTypes010 from './interfaces/friday-agent-types.js'; // import friday:agent/types@0.1.0
...
export * as agent from './interfaces/friday-agent-agent.js'; // export friday:agent/agent@0.1.0
